...
$(document).ready(function(){
    $('#view').click(function(){
        ...
        var htmlDiv='<div style="margin:2px"><iframe width="100%" height="160" src="https://www.youtube.com/embed/'+videoId+'?feature=oembed&autoplay=1&mute=1" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen=""></iframe></div>'
        $('.frames').empty()
        for(var i=0;i<no;i++)
        {
